...
export default function NewProductClient({data}: {data: NewProduct[]}) {
    ...
    <>
        ...
        {data.map((item) => (
            <SwiperSlide key={item.id}>
                <NewProductItem title={item.title} url={`products/${item.category_url+"/"+item.url}`} img={BaseUrl()+item.cover_img} />
            </SwiperSlide>
        ))}
